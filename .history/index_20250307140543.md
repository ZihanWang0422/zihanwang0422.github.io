...
<div style="padding-left: 20px;">
  <div class="image-container2" style="display: flex; gap: 20px; align-items: center;">
    <!-- <img src="assets/competition/zhixingmini.png" 
         style="width: 300px; height: 200px; object-fit: contain"/> -->
  ...
  <tbody>
      <tr>
        ...
        <td style="vertical-align: top;">
          <div>
            <span style="font-family: 'Helvetica Neue Thin'; font-size: 1.15rem;font-weight: bold;">Plasma-propelled Ultra-quiet Flying Robot</span>
            <br>
            <span class="icon-star-full" aria-hidden="true"></span>
            <span style="font-family: 'Comic Sans MS'; color: #6495ED; font-weight:bold; font-size:1.0rem">Sliding Model Control</span>
            <!-- 链接 -->
            <h4 class="h3" style="color: rgb(128 128 128); font-weight: bold; font-size: 1.0rem; margin: 0.5em 0;">
              <span style="font-size: 1.1rem;">Links:</span> 
            ...
            <ul style="margin-top: 0; padding-left: 20px;">
              <li style="font-size: 15px; color: gray; margin-bottom: 0.5em;">
