        ...
        <td style="vertical-align: top;">
          <div style="padding-left: 15px;">
            ...
            <div style="color: gray; font-size: 0.9rem; line-height: 1.5;">
              In this project we proposed a plasma propeller, adn I designed a robotic arm that can remotely control pitch and roll angle of the airship.
            </div>
          </div>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td style="vertical-align: top;">
          <div style="padding-left: 15px;">
            ...
            <!-- 项目描述 -->
            <div style="color: gray; font-size: 0.9rem; line-height: 1.5;">
                I Achieved fast and automatic planning and navigation that avoids randomly positioned obstacles, using Proportional-integral-derivative (PID) control and A* Search Algorithms.
            </div>
          </div>
        </td>
      </tr>
