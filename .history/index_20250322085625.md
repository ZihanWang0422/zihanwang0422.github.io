...
<!-- 教育经历部分 -->
<div style="display: flex; align-items: center; margin: 0 0 1.2rem 0">  <!-- 增大下边距至1.2rem -->
  <div style="width: 15%; display: inline-block;">
  ...
  <div style="padding-left: 4%; width: 83%; display: inline-block; height: 100%;">
    ...
    <span style="font-size: 15px;">Major:</span> <span style="font-size: 15px; font-weight: bold;">Automation</span>
  </div> <!-- 移除最后一个<br> -->
</div>

<div style="display: flex; align-items: center; margin: 0 0 1.2rem 0">  <!-- 统一间距 -->
  <div style="width: 15%; display: inline-block;">
  ...
  <div style="padding-left: 4%; width: 83%; display: inline-block; height: 100%;">
    <span>
      ...
      <span style="font-size: 15px; float: right">Aug. 2025 - Nov. 2026</span>
    </span><br>
    <span style="font-size: 15px;">Master Student</span><br>
    <span style="font-size: 15px;">Major:</span> <span style="font-size: 15px; font-weight: bold;">Robotics</span>
  </div> <!-- 移除最后一个<br> -->
</div>

<!-- 研究经历部分 -->
<h3 class="h2" style="color: rgb(1,92,171); font-size: 25px; font-weight: bold; margin: 1.5rem 0 1rem 0">Experience</h3>  <!-- 增加标题上下边距 -->
<div>
  <div style="display: flex; align-items: center; margin: 0 0 1rem 0">  <!-- 统一间距 -->
    <div style="width: 15%; display: inline-block;">
      <img src="assets/images/nus.jpg" style="border-radius: 50%;">
    </div>
    <div style="padding-left: 4%; width: 83%; display: inline-block;">
      ...
      <span style="font-size: 15px;">Topic: <a href="https://docs.google.com/presentation/d/1AB1nN69qvbDMoYwKr_wVQCPA4gvBt-gM/edit?usp=drive_link&ouid=110514396844944080931&rtpof=true&sd=true" target="_blank">Vision Language Based 6-Dof Grasp</a></span>
    </div> <!-- 移除最后一个<br> -->
  </div>

  <div style="display: flex; align-items: center; margin: 0 0 1rem 0">  <!-- 统一间距 -->
    <div style="width: 15%; display: inline-block;">
      <img src="assets/images/THBI.jpg" style="border-radius: 50%;" width="100%">
    </div>
    <div style="padding-left: 4%; width: 83%; display: inline-block;">
      <span>
      ...
      <span style="font-size: 15px;">Topic: VLA Navigation Car</span>
    </div> <!-- 移除最后一个<br> -->
  </div>
</div>
    <!-- <br>
