...
https://blog.csdn.net/qq\_34972053/article/details/127689332
...
2. Docker 配置：https://docs.isaacsim.omniverse.nvidia.com/latest/installation/install\_container.html
   ...
   * Docker + Nvidia container toolkit: https://blog.csdn.net/guoqingru0311/article/details/145926492
   ...
   * 问题解决记录1：nvidia-container-cli: initialization error: load library failed
   ...
   https://github.com/NVIDIA/nvidia-docker/issues/1648#issuecomment-1785033393
...
* ROS2 Installization
  ...
  * Set up Isaac Sim ROS Workspaces
    ...
    下载ws：https://github.com/isaac-sim/IsaacSim-ros\_workspaces
...
Doc:https://docs.isaacsim.omniverse.nvidia.com/latest/ros2\_tutorials/tutorial\_ros2\_navigation.html#ros2-navigation
...
2. Occupancy Map
   ...
   https://docs.isaacsim.omniverse.nvidia.com/latest/ros2\_tutorials/tutorial\_ros2\_navigation.html#occupancy-map
...
3. Reconstruction + Nav2
   ...
   ```
     ...
     ⚠️Crash：点击play后会出现crash提示或者在运行一段Nav2后会出现 llvm: out of memory
...
<img src="./2025-06-11-IsaacSim-Setup.assets/1749620079173-1.png" alt="img" style="zoom:33%;" />

4. Reconstruction + Segmantic image

<img src="./2025-06-11-IsaacSim-Setup.assets/1749620099261-4.png" alt="img" style="zoom:33%;" />
