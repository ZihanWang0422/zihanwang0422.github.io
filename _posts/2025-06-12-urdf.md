...
1. Fusion 360建模
   ...
   首先将整个主体部分的坐标系切换到标准位置，然后要将除四个轮子、雷达、imu、realsense的其他部分全部合并一个实体(base_link)
   ...
   * joint设定：
   ...
   <img src="./2025-06-12-urdf.assets/image-3.png" alt="image-3">

   <img src="./2025-06-12-urdf.assets/image-5.png" alt="image-5" style="width: 50%;">

   * 文件结构：

   <img src="./2025-06-12-urdf.assets/image-4.png" alt="image-4">
...
<img src="./2025-06-12-urdf.assets/image-2.png" alt="image-2">
...
<img src="./2025-06-12-urdf.assets/image.png" alt="image" style="width: 67%;">
...
<img src="./2025-06-12-urdf.assets/image-1.png" alt="image-1">
